...
import { Wrench, Cable, Factory, ArrowRight } from "lucide-react";
...
const EngineeringSection = () => {
  return (
    <Element name="engineering">
      ...
      >
        {/* 🔆 Static, Positioned Glow Effects */}
        ...
        {/* 🛠️ Glass Card Content */}
        <motion.div
          initial={{ opacity: 0, y: 40 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{once:true}}
          transition={{ duration: 0.8, ease: "easeOut" }}
          className="relative z-10 max-w-4xl w-full bg-white/10 backdrop-blur-md p-10 rounded-xl shadow-lg border border-white/10 text-white"
        >
          <h2 className="text-4xl font-bold mb-6 uppercase tracking-widest text-center">
            Engineering
          </h2>

          <p className="text-lg mb-6 text-gray-100 text-center">
            Our engineering division delivers precision and performance across
            industries:
          </p>
          ...
          <ul className="space-y-4 text-left font-medium mb-10">
            ...
            <li className="flex items-center gap-3">
              ...
              Tubing & Piping Work for the Marine Sector
            </li>
            <li className="flex items-center gap-3">
              <Factory size={20} className="text-red-400" />
              Power Generation & Oil/Petrochemical Support (Singapore & Baku)
            </li>
          </ul>
          
          {/* TMT Glow Button */}
          <div className="flex justify-center mt-6">
            <a href='https://tmt-engineering.vercel.app/' target="_blank" className="group relative px-6 cursor-pointer py-3 rounded-lg bg-slate-800 text-white font-bold text-lg flex items-center gap-2 overflow-hidden transition-all duration-300 hover:shadow-lg hover:translate-y-px">
              {/* Button content */}
              <span className="relative z-10">Explore Engineering Services</span>
