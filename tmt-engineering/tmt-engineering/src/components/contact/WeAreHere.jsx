...
const WeAreHere = () => {
  return (
    <section className="bg-te-back py-20 px-4 flex flex-col items-center text-te-text">
      ...
      <div className="w-full max-w-6xl shadow-[10px_10px_30px_#d1fae5,_-10px_-10px_30px_#ffffff] rounded-2xl overflow-hidden transition-transform hover:scale-[1.01] bg-te-sec">
        <iframe
