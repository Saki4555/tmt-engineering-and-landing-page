            ...
            <div className="space-y-8">
              ...
              >
                <p className="text-lg leading-relaxed text-[var(--color-te-text)]">
                  ...
                  has been awarded with Biz-safe level 4 by WHS council in
                  recognition of our organization's Quality System Compliance
                  since 2002.
                </p>
              </div>
              ...
              <div className="space-y-4 px-2">
                <p className="text-lg leading-relaxed text-[var(--color-te-text)]">
                  We plan, implement and maintain an efficient and effective
                  quality management system with continuous review and
                  improvements. This ensures that our services and products will
                  satisfy the requirements and expectations of both internal and
                  external customers.
                </p>

                <p className="text-lg leading-relaxed text-[var(--color-te-text)]">
                  You may also be interested to find out about the wide range of
