        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service, index) => (
            ...
            >
                    ...
                    <ul className="space-y-3">
                      {(expandedItems[index]
                        ...
                        <li key={idx} className="flex items-start">
                          <div className="mr-3 mt-1 rounded-full flex-shrink-0 w-4 h-4 flex items-center justify-center bg-[var(--color-te-sec)] shadow-[2px_2px_4px_#C7DDFE,-2px_-2px_4px_#FFFFFF]">
                            <div className="w-2 h-2 rounded-full bg-[var(--color-te-prim)]"></div>
                          </div>
              ...
              {/* Subtle accent line */}
              <div className="absolute bottom-0 left-0 right-0 h-1 bg-gradient-to-r from-transparent via-[var(--color-te-prim)]/20 to-transparent"></div>
            </div>
          ))}
        </div>
      </div>
